...
//
//     final coinDataModel = coinDataModelFromJson(jsonString);

import 'dart:convert';

List<CoinDataModel> coinDataModelFromJson(String str) => List<CoinDataModel>.from(json.decode(str).map((x) => CoinDataModel.fromJson(x)));

String coinDataModelToJson(List<CoinDataModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class CoinDataModel {
    ...
    factory CoinDataModel.fromJson(Map<String, dynamic> json) => CoinDataModel(
        id: json["id"],
        symbol: json["symbol"],
        name: json["name"],
        image: json["image"],
